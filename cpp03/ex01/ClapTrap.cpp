...
/*   Updated: 2023/05/28 19:08:05 by jefernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _hitPoints(100), _energyPoints(50), _attackDamage(20), _name("Robot"){
	std::cout << GRN << "Default constructor called." << RESET << std::endl;
	return;
}
ClapTrap::ClapTrap(std::string const& name) : _name(name), _hitPoints(100), _energyPoints(50), _attackDamage(20) {
