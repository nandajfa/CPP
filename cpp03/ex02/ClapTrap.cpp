...
/*   Updated: 2023/05/28 19:10:17 by jefernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _hitPoints(100), _energyPoints(100), _attackDamage(30), _name("Robot"){
	std::cout << GRN << "Default constructor called." << RESET << std::endl;
	return;
}
ClapTrap::ClapTrap(std::string const& name) : _name(name), _hitPoints(100), _energyPoints(100), _attackDamage(30) {
...
ClapTrap::~ClapTrap(void){
	std::cout << GRN << "Destructor called." << RESET << std::endl;
	return;
}
